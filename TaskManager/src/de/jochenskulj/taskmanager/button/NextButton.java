...
/**
 * Button to go to the next object
 */
public class NextButton extends JButton implements ActionListener {
     ...
     */
    public NextButton(ApplicationFrame aFrame) {
        super();
        frame = aFrame;
        setIcon(IconFactory.createIcon(IconFactory.NEXT));
    ...
    public void actionPerformed(ActionEvent arg0) {
    	try {
    		frame.getApplication().selectNext();
    ...
    private void setKeyBinding() {
    	KeyStroke keyStroke = KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, 
    			KeyEvent.CTRL_MASK);
