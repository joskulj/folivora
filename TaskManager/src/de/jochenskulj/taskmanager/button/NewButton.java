...
public class NewButton extends JButton implements ActionListener {
     ...
     */
    public NewButton(ApplicationFrame aFrame) {
        super();
        frame = aFrame;
        setIcon(IconFactory.createIcon(IconFactory.NEW));
        addActionListener(this);
        setToolTipText("Create new entry (Ctrl-N)");
        setKeyBinding();
    }
    ...
    public void actionPerformed(ActionEvent arg0) {
    	try {
    		frame.getApplication().createNewElement();
