...
/**
 * Command to save the file as a new file
 */
public class SaveAsCommand  extends CommandBase {
     ...
     */
    public SaveAsCommand(Application application) {
        super(CommandBase.SAVE_AS, application);
    }
    ...
    public void execute() {
    	...
    	logger.debug("SaveAsCommand.execute() entered");
    	...
    	logger.debug("SaveAsCommand.execute() exited");
