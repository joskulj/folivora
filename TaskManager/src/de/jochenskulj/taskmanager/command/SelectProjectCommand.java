...
/**
 * Command to select the projects objects
 */
public class SelectProjectCommand extends CommandBase {
     ...
     */
    public SelectProjectCommand(Application application) {
        super(CommandBase.PROJECT, application);
    }
    ...
    public void execute() {
    	...
    	logger.debug("SelectProjectCommand.execute() entered");
    	
    	try {
	    	ApplicationModel model = getApplication().getModel();
	    	ElementType type = model.getProjectList().getType();
