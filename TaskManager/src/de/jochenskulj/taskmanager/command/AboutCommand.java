...
import de.jochenskulj.taskmanager.view.AboutDialog;
...
public class AboutCommand extends CommandBase {
     ...
     */
    public AboutCommand(Application application) {
        super(CommandBase.ABOUT, application);
    }
    ...
    @Override
    public void execute() {
    	JFrame owner = getApplication().getFrame().getFrame();
