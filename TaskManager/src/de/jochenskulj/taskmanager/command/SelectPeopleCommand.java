...
/**
 * Command to select the people objects
 */
public class SelectPeopleCommand extends CommandBase {
     ...
     */
    public SelectPeopleCommand(Application application) {
        super(CommandBase.PEOPLE, application);
    }
